...
if (!class_exists('EDD_Fondy')) :
    ...
    class EDD_Fondy
    {
        ...
        private function __construct($file)
        {
            ...
            $this->fondy_url = 'https://payment.albpay.io/api/checkout/url/';
        ...
        {
            $icons[$this->plugin_url . 'assets/images/fondy_logo.png'] = 'Alliance bank Payment Provider';
        ...
        private function fondy_post($headers = array(), $body = array())
        {
            ...
            $response = wp_remote_post($this->fondy_url,
                array(
                    'redirection' => 5,
                    'httpversion' => '1.0',
                    'user-agent' => 'EDD Alliance bank' . $this->version . '; WordPress (' . home_url('/') . ')',
                    'timeout' => 15,
                    'body' => $body,
                    'headers' => $headers
                )
        ...
        public function register_gateway($gateways)
        {
            ...
            $gateways['fondy'] = array('admin_label' => __('Alliance bank', 'edd_fondy'), 'checkout_label' => __('Alliance bank Payments', 'edd_fondy'));
        ...
        public function add_settings_gateways($settings)
        {
            ...
            $edd_fondy_settings = array(
                ...
                array(
                    ...
                    'desc' => __('Enter your Merchant ID, you can find it <a href=https://portal.albpay.io/mportal/#/settings/ target=_blank>here</a>.', 'edd_fondy'),
                    'type' => 'text',
                    'size' => 'regular'
                ),
                array(
                    ...
                    'desc' => __('Enter your Secret Key, you can find it <a href=https://portal.albpay.io/mportal/#/settings/ target=_blank>here</a>.', 'edd_fondy'),
                    'type' => 'password',
                    'size' => 'regular'
                ),
                array(
        ...
        public function process_fondy_notify()
        {
            ...
            if (isset($_POST['order_id']) && $valid) {
                ...
                if (($ref != 'secure-redirect.cloudipsp.com') and ($ref != 'payment.albpay.io')) {
                    return false;
                }
                */
