...
{
    add_menu_page('Alliance bank RCP payment', 'Alliance bank RCP payment', 'manage_options', '/fondy-admin-page.php', 'rcp_fondy_admin_page', 'dashicons-admin-settings', 6);
}
    ...
    <form method="post" action="options.php" class="rcp_options_form">
        ...
        <div class="tab_content" id="payments">
            <table class="form-table">
                <tr valign="top">
                    <th colspan=2>
                        <h3><?php _e('Alliance bank Settings', 'fondy_rcp'); ?></h3>
                    </th>
                </tr>
                ...
                <tr>
                    <th>
                        <label
                                for="rcp_fondy_settings[fondy_merchant_id]"><?php _e('Alliance bank MID', 'fondy_rcp'); ?></label>
                    </th>
                    <td>
