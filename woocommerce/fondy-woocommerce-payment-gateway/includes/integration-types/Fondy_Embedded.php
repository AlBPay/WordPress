...
trait Fondy_Embedded
{
    ...
    public function includeEmbeddedAssets()
    {
        ...
        wp_enqueue_style('fondy-vue-css', 'https://payment.albpay.io/latest/checkout-vue/checkout.css', null, WC_FONDY_VERSION);
        wp_enqueue_script('fondy-vue-js', 'https://payment.albpay.io/latest/checkout-vue/checkout.js', null, WC_FONDY_VERSION);
