...
class WC_Gateway_Fondy_Bank extends WC_Fondy_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_title = 'Alliance bank Bank';
    ...
    public function init_form_fields()
    {
        $this->form_fields = [
            'enabled' => [
                ...
                'type' => 'checkbox',
                'label' => __('Enable Alliance bank Bank Gateway', 'fondy-woocommerce-payment-gateway'),
                'default' => 'no',
            ...
            'title' => [
                ...
                'default' => __('Alliance bank Online Banking', 'fondy-woocommerce-payment-gateway'),
                'desc_tip' => true,
            ],
            'description' => [
                'title' => 'Description',
